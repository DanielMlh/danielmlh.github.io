...
var ListCarsComponent = /** @class */ (function () {
    function ListCarsComponent(http, userService, router) {
        this.http = http;
    ...
    ListCarsComponent.prototype.handleFileSelect = function (event) {
    ...
    ListCarsComponent.prototype._handleReaderLoaded = function (readerEvt) {
        var binaryString = readerEvt.target.result;
        this.car.picture = btoa(binaryString);
    };
    //****Function adding new car to database*****/
    ListCarsComponent.prototype.AddNewCar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        document.getElementById('preloader').style.display = "block";
                        this.closeForm();
                        return [4 /*yield*/, this.http.post("http:// www.serverapi.somee.com/api/car/", {
                            ...
                            }, { headers: authHeaders }).toPromise().then(function (h) { return console.log(h); }).catch(function (err) { return alert(err.error); })];
                    case 1:
                        _a.sent();
                        this.ngOnInit();
    ...
    ListCarsComponent.prototype.AddNewTypeCar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders, year;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        year = ((this.typeCar.YearManufacturer).toString()).slice(0, -6);
                        this.typeCar.CarType = this.typeCar.ManufacturerNmae + " " + this.typeCar.Model + " " + year;
                        document.getElementById('preloader').style.display = "block";
                        this.closeForm();
                        return [4 /*yield*/, this.http.post("http:// www.serverapi.somee.com/api/typecar/", {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/car/" + id, {
                                CarType: cType,
                                Mileage: mileage,
                                Branch: branch,
                                Available: available,
                                Usable: usable,
                                PictureBase64: this.car.picture
                            }, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 1:
                        _a.sent();
                        this.car.picture = undefined;
                        this.ngOnInit();
    ...
    ListCarsComponent.prototype.UpdateTypeCar = function (id, manufacturerNmae, model, dalyPrice, delayDalyPrice, yearManufacturer, transmission) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/typecar/" + id, {
    ...
    ListCarsComponent.prototype.DeleteCar = function (carId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.http.delete("http:// www.serverapi.somee.com/api/car/" + carId, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 1:
                        _a.sent();
                        this.ngOnInit();
                        document.getElementById('preloader').style.display = "none";
    ...
    ListCarsComponent.prototype.DeleteTypeCar = function (carTypeId, carId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/car/" + carId, {
                                CarType: 'none', Usable: 'no'
                            }, { headers: authHeaders }).toPromise()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.http.delete("http:// www.serverapi.somee.com/api/typecar/" + carTypeId, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 2:
                        _a.sent();
                        this.ngOnInit();
                        document.getElementById('preloader').style.display = "none";
    ...
    ListCarsComponent.prototype.ngOnInit = function () {
        var _this = this;
        //*****if not admin role routing to home page****
        if (this.userService.userRole() != 'admin' || this.userService.userRole() == undefined) {
            this.router.navigate(['/HomePage']);
        }
        this.http.get("http:// www.serverapi.somee.com/api/car/").subscribe(function (t) { _this.carList = t; });
        this.http.get("http:// www.serverapi.somee.com/api/typecar/").subscribe(function (t) { _this.typeList = t, _this.typeList2 = t; });
    };
    ListCarsComponent.ctorParameters = function () { return [
...
var ListOrdersComponent = /** @class */ (function () {
    function ListOrdersComponent(http, userService, router) {
        this.http = http;
        this.userService = userService;
        this.router = router;
        this.today = new Date();
    ...
    //****function to open form in template/html*****
    ListOrdersComponent.prototype.openForm = function () {
        document.getElementById("addOrderForm").style.display = "block";
    };
    //****function to close form in template/html*****
    ListOrdersComponent.prototype.closeForm = function () {
        document.getElementById("addOrderForm").style.display = "none";
    };
    //****Function adding new order to database*****/
    ListOrdersComponent.prototype.AddNewOrder = function (carId, userId, picupDate, dropOffDate) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        document.getElementById('preloader').style.display = "block";
                        this.closeForm();
                        return [4 /*yield*/, this.http.post("http:// www.serverapi.somee.com/api/RentCar/", {
                                CarID: carId,
                                UserID: userId,
                                PickupCar: picupDate,
    ...
    ListOrdersComponent.prototype.OverdueDate = function (dropOffDate) {
    ...
    ListOrdersComponent.prototype.Update = function (Id, carId, picupDate, dropOffDate, dropOffOverdue) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        document.getElementById('preloader').style.display = "block";
                        this.closeForm();
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/RentCar/" + Id, {
                                CarID: carId,
                                PickupCar: picupDate,
                                ReturnCar: dropOffDate,
    ...
    ListOrdersComponent.prototype.Delete = function (Id, carNumber) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        document.getElementById('preloader').style.display = "block";
                        this.closeForm();
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/Car/" + carNumber, {
                                Available: 'yes',
                            }, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.http.delete("http:// www.serverapi.somee.com/api/RentCar/" + Id, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 2:
                        _a.sent();
                        this.ngOnInit();
                        document.getElementById('preloader').style.display = "none";
    ...
    ListOrdersComponent.prototype.ngOnInit = function () {
        ...
        this.http.get("http:// www.serverapi.somee.com/api/car/").subscribe(function (t) { return _this.carList = t; });
        this.http.get("http:// www.serverapi.somee.com/api/RentCar/").subscribe(function (t) { return _this.rentCarList = t; });
        var authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
        this.http.get("http:// www.serverapi.somee.com/api/user/", { headers: authHeaders }).subscribe(function (h) { return _this.usersList = h; });
    };
    ListOrdersComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
...
var ListUsersComponent = /** @class */ (function () {
    function ListUsersComponent(http, userService, router) {
        this.http = http;
        this.userService = userService;
        this.router = router;
    ...
    //****function to open form in template/html*****
    ListUsersComponent.prototype.openForm = function () {
        document.getElementById("addUserForm").style.display = "block";
    };
    //****function to close form in template/html*****
    ListUsersComponent.prototype.closeForm = function () {
        document.getElementById("addUserForm").style.display = "none";
    };
    //****Function adding new user to database*****/
    ListUsersComponent.prototype.AddNewUser = function (fName, lName, id, u_email, bDay, gender, userName, password, role) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        document.getElementById('preloader').style.display = "block";
                        this.closeForm();
                        return [4 /*yield*/, this.http.post("http:// www.serverapi.somee.com/api/user/", {
                                FirstName: fName,
                                LastName: lName,
                                UserID: id,
                                UserName: userName,
                                ...
                                Role: role
                            }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 1:
                        _a.sent();
                        this.ngOnInit();
                        document.getElementById('preloader').style.display = "none";
    ...
    ListUsersComponent.prototype.Update = function (id, f_Nmae, l_Name, userId, email, birthDay, gender, userName, password, role) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/user/" + id, {
                                FirstName: f_Nmae,
                                LastName: l_Name,
                                UserID: userId,
                                Email: email,
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.http.delete("http:// www.serverapi.somee.com/api/user/" + id, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 1:
                        _a.sent();
                        this.ngOnInit();
                        document.getElementById('preloader').style.display = "none";
    ...
    ListUsersComponent.prototype.ngOnInit = function () {
        ...
        var authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
        this.http.get("http:// www.serverapi.somee.com/api/user/", { headers: authHeaders }).subscribe(function (h) { return _this.usersList = h; }, function (error) { _this.error = error; });
    };
...
var CalcDayPriceComponent = /** @class */ (function () {
    function CalcDayPriceComponent(userService, http, router) {
        this.userService = userService;
        this.http = http;
        this.router = router;
        this.today = Date();
    ...
    CalcDayPriceComponent.prototype.calcPayment = function () {
        return this.rentDays * this.userService.userCar[1].DalyPrice;
    };
    //*****function returns picup date*****
    CalcDayPriceComponent.prototype.PicUpDate = function (picupDate) {
        var pdate = new Date(picupDate);
    ...
    CalcDayPriceComponent.prototype.DropOffDate = function () {
        var pickupDate = new Date(this.rentCar.PickupCar);
    ...
    CalcDayPriceComponent.prototype.Confirm = function () {
        this.DropOffDate();
        var authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
        ...
        }, { headers: authHeaders }).subscribe(function (h) { return console.log(h); });
        this.http.put("http:// www.serverapi.somee.com/api/Car/" + this.rentCar.CarID, {
            Available: 'no',
        }, { headers: authHeaders }).subscribe(function (h) { return console.log(h); });
        alert('Your order has been confirmed!');
        this.router.navigate(['/HomePage']);
        for (var index = 0; index < this.userService.choicesOfCar.length; index++) {
            if (this.userService.choicesOfCar[index].CarID == this.rentCar.CarID) {
                this.userService.choicesOfCar.splice(index, 1);
            }
        }
    };
    CalcDayPriceComponent.prototype.ngOnInit = function () {
    };
    CalcDayPriceComponent.ctorParameters = function () { return [
...
var RegisterPageComponent = /** @class */ (function () {
    function RegisterPageComponent(http) {
        this.http = http;
        this.user = new _user__WEBPACK_IMPORTED_MODULE_3__["User"]();
        this.Years18 = Date.now() - 568025136000;
    }
    //***function adding new user to database */
    RegisterPageComponent.prototype.Registrarion = function () {
        this.http.post("http:// www.serverapi.somee.com/api/user/", {
            ...
            .subscribe(function (h) { return console.log(h); }, function (err) { return alert(err.error); });
    };
...
var SearchCarComponent = /** @class */ (function () {
    function SearchCarComponent(http, userService, router) {
        var _this = this;
        this.http = http;
        this.userService = userService;
        this.router = router;
        this.today = Date();
        this.http.get("http:// www.serverapi.somee.com/api/typecar/").subscribe(function (t) { return _this.typeCarList = t; });
        this.http.get("http:// www.serverapi.somee.com/api/car/").subscribe(function (t) { return _this.carList = t; });
    }
    //****function to select car by user anf checking if user registered***
    SearchCarComponent.prototype.selectCar = function (car, carType) {
    ...
    SearchCarComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var UserAllOrdersComponent = /** @class */ (function () {
    function UserAllOrdersComponent(http, router, userService) {
        this.http = http;
        this.router = router;
        this.userService = userService;
        this.today = new Date();
    }
    UserAllOrdersComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    UserAllOrdersComponent.ctorParameters = function () { return [
...
var UserOrderComponent = /** @class */ (function () {
    function UserOrderComponent(http, userService, router) {
        this.http = http;
        this.userService = userService;
        this.router = router;
        this.today = new Date();
    ...
    //***function calculate regular price*****/
    UserOrderComponent.prototype.CalcPrice = function (dateD, dateP, price) {
        var dateDropOff = new Date(dateD).getTime();
        var datePicup = new Date(dateP).getTime();
        var days = Math.floor((dateDropOff - datePicup) / (1000 * 60 * 60 * 24));
        return days * price;
    };
    ;
    //***function calculate overdue price*****/
    UserOrderComponent.prototype.CalcOverduePrice = function (dateD, price, dateP) {
        var dateOverdue = new Date(this.today.getFullYear(), this.today.getMonth(), this.today.getDate()).getTime();
        var dateDropOff = new Date(dateD).getTime();
        var days = Math.ceil((dateOverdue - dateDropOff) / (1000 * 60 * 60 * 24));
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.UserRole = function () {
    ...
    AppComponent.prototype.LoginConfirm = function () {
    ...
    AppComponent.prototype.selectCar = function (car, carType) {
        var head = document.getElementById('navbarSupportedContent');
        head.scrollIntoView(false);
        this.userService.addCar(car, carType);
        this.router.navigate(['/CalcDayPrice']);
    };
    //***function  scroll to footer  */
    AppComponent.prototype.GoToFooter = function (id) {
...
var Car = /** @class */ (function () {
    ...
    Object.defineProperty(Car.prototype, "carNumber", {
        get: function () {
    ...
    Object.defineProperty(Car.prototype, "picture", {
        get: function () {
    ...
    Object.defineProperty(Car.prototype, "usable", {
        get: function () {
            return this._usable;
        },
        set: function (v) {
    ...
    Object.defineProperty(Car.prototype, "available", {
        get: function () {
    ...
    Object.defineProperty(Car.prototype, "branch", {
        get: function () {
            return this._branch;
        },
        set: function (v) {
...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(http, userService, router) {
        this.http = http;
        this.userService = userService;
        this.router = router;
        this.today = new Date();
    ...
    //***function calculate regular price*****/
    EmployeeComponent.prototype.CalcPrice = function (dateD, dateP, price) {
        var dateDropOff = new Date(dateD).getTime();
        var datePicup = new Date(dateP).getTime();
        var days = Math.floor((dateDropOff - datePicup) / (1000 * 60 * 60 * 24));
        return (days * price);
    ...
    ;
    //***function calculate overdue price*****/
    EmployeeComponent.prototype.CalcOverduePrice = function (dateD, price, dateP) {
        var dateOverdue = new Date(this.today.getFullYear(), this.today.getMonth(), this.today.getDate()).getTime();
        var dateDropOff = new Date(dateD).getTime();
        var days = Math.ceil((dateOverdue - dateDropOff) / (1000 * 60 * 60 * 24));
        var datePicup = new Date(dateP).getTime();
    ...
    EmployeeComponent.prototype.Payment = function (carId, id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var authHeaders;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Authorization", "Basic " + this.userService.loginUser.UserName + ":" + this.userService.loginUser.UserPassword);
                        if (!confirm("Are you sure to confirm this payment?")) return [3 /*break*/, 3];
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/RentCar/" + id, { ReturnCarIndeed: this.today }, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.http.put("http:// www.serverapi.somee.com/api/car/" + carId, { Available: 'yes' }, { headers: authHeaders }).toPromise().catch(function (err) { return alert(err.error); })];
                    case 2:
                        _a.sent();
                        this.ngOnInit();
                        document.getElementById('preloader').style.display = "none";
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        document.getElementById('preloader').style.display = "block";
                        return [4 /*yield*/, this.userService.LogIn(this.loginUser.userName, this.loginUser.password)];
                    case 1:
                        result = _a.sent();
                        document.getElementById('preloader').style.display = "none";
                        if (result == true) {
...
var AvailableCarPipe = /** @class */ (function () {
    //****returns of available cars****
    function AvailableCarPipe() {
    }
    AvailableCarPipe.prototype.transform = function (arrCars) {
        if (arrCars != null) {
            var arrAvailableCars = [];
...
var RemoveDuplicatePipe = /** @class */ (function () {
    //******remove duplicate items from selection */
    function RemoveDuplicatePipe() {
    }
    RemoveDuplicatePipe.prototype.transform = function (arrItems, item) {
        var arrItemsNew = [];
        if (arrItems != null) {
            arrItemsNew[0] = arrItems[0];
            for (var index = 1; index < arrItems.length; index++) {
                var result = false;
                if (item == 'YearManufacturer') {
                    for (var indexNew = 0; indexNew < arrItemsNew.length; indexNew++) {
                        var items = new Date(arrItems[index][item]);
                        var itemsNew = new Date(arrItemsNew[indexNew][item]);
...
var ResultSearchCarPipe = /** @class */ (function () {
    //******returns selected cars in search by user */
    function ResultSearchCarPipe() {
    }
    ResultSearchCarPipe.prototype.transform = function (arrCars, txt, manufacturer, model, transmission, yearManufacturer) {
        if (txt == undefined && manufacturer == undefined && model == undefined && transmission == undefined && yearManufacturer == undefined) {
            ...
            if (txt != undefined) {
                var arrTxt = [];
                for (var i = 0; i < arrResultCars.length; i++) {
            ...
            if (yearManufacturer != undefined) {
                var arrYearManufacturer = [];
                for (var i = 0; i < arrResultCars.length; i++) {
                    var yearCar1 = new Date(arrResultCars[i].YearManufacturer);
                    var yearCar2 = new Date(yearManufacturer);
...
var SearchNumberCarPipe = /** @class */ (function () {
    //****returns cars by number in search***
    function SearchNumberCarPipe() {
    }
    SearchNumberCarPipe.prototype.transform = function (arrCars, txt) {
        var arrNotAvailable = [];
        if (arrCars != null) {
            for (var index = 0; index < arrCars.length; index++) {
            ...
            if (txt == undefined) {
                ...
                var arrResultCars = [];
                for (var i = 0; i < arrNotAvailable.length; i++) {
                    var carNumber = arrNotAvailable[i].CarID;
                    var arrToString = carNumber.toString();
...
var RentCar = /** @class */ (function () {
    function RentCar() {
    }
    Object.defineProperty(RentCar.prototype, "PickupCar", {
        get: function () {
    ...
    Object.defineProperty(RentCar.prototype, "ReturnCar", {
        get: function () {
    ...
    Object.defineProperty(RentCar.prototype, "CarID", {
        get: function () {
            return this._CarID;
        },
        set: function (v) {
    ...
    Object.defineProperty(RentCar.prototype, "UserID", {
        get: function () {
            return this._UserID;
        },
        set: function (v) {
...
var TypeCar = /** @class */ (function () {
    function TypeCar() {
    }
    Object.defineProperty(TypeCar.prototype, "CarType", {
        get: function () {
            return this._CarType;
        },
        set: function (v) {
    ...
    Object.defineProperty(TypeCar.prototype, "ManufacturerNmae", {
        get: function () {
    ...
    Object.defineProperty(TypeCar.prototype, "Model", {
        get: function () {
            return this._Model;
        },
        set: function (v) {
    ...
    Object.defineProperty(TypeCar.prototype, "DalyPrice", {
        get: function () {
    ...
    Object.defineProperty(TypeCar.prototype, "DelayDalyPrice", {
        get: function () {
    ...
    Object.defineProperty(TypeCar.prototype, "YearManufacturer", {
        get: function () {
    ...
    Object.defineProperty(TypeCar.prototype, "Transmission", {
        get: function () {
...
var UserService = /** @class */ (function () {
    ...
    Object.defineProperty(UserService.prototype, "loginUser", {
        get: function () {
    ...
    UserService.prototype.LogIn = function (userName, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set("Authorization", "Basic " + userName + ":" + password);
                        return [4 /*yield*/, this.http.get("http:// www.serverapi.somee.com/api/user/" + userName, { headers: authHeaders })
                                .toPromise().then(function (h) { return _this.loginUser = h; })
                                .catch(function (x) { return Promise.reject("error is " + x); })
                                .then(function (x) { return console.log('login succeeded'); }, function (err) { return console.log('wrong user name or password', err); })];
                    case 1:
                        _a.sent();
                        ;
    ...
    //****finction returns status of login*****
    UserService.prototype.confirmLogin = function () {
    ...
    //******function returns rolse of users***********
    UserService.prototype.userRole = function () {
        if (this.loginUser == undefined)
            return "user";
        else
    ...
    UserService.prototype.addCar = function (car, typeCar) {
        var arr = [];
        arr.push(car);
        arr.push(typeCar);
        this.userCar = arr;
        var dublicate = 'no';
        for (var i_available = 0; i_available < this.choicesOfCar.length; i_available++) {
